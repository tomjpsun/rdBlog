...
BLOG_AUTHOR = "Ching Ping Sun"  # (translatable)
BLOG_TITLE = "Blending Everything"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://rd.coding-addict.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://rd.coding-addict.com/"
BLOG_EMAIL = "tomjpsun@gmail.com"
BLOG_DESCRIPTION = "Time machine of memory"  # (translatable)
...
DEPLOY_COMMANDS = {'default': [
    'rsync -arvz -e  --progress --delete ./output tomjpsun@rd.coding-addict.com:/public_html/rd'
]}
